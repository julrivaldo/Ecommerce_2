...
if (isset($_POST['order-btn'])) {
    ...
    $flate = mysqli_real_escape_string($conn, $_POST['flate']);
    ...
    $address = 'flat no. ' . $flate . ',' . $street . ',' . $city . ',' . $state . ',' . $country . ',' . $pin;
    ...
    $insert_order_query = "INSERT INTO `order` (user_id, name, number, email, method, address, total_products, total_price, placed_on)
...
?>
        ...
        <form method="post">
            ...
            <div class="input-field">
                <label>city</label>
                <input type="text" name="city" placeholder="e.g jakarta">
            </div>
            <div class="input-field">
                <label>state</label>
                <input type="text" name="state" placeholder="e.g south jakarta">
            </div>
            <div class="input-field">
                <label>country</label>
            ...
            <div class="input-field">
                ...
                <input type="text" name="pin" placeholder="e.g 15433">
            </div>
