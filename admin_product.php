...
if (isset($_POST['add_product'])) {
    ...
    if (mysqli_num_rows($select_product_name) > 0) {
        ...
        if ($image_size > 2000000) {
            ...
            $message[] = 'prodduct added successfully';
        }
    }
}
...
if (isset($_POST['update_product'])) {
    ...
    '$update_price',`product_detail` = '$update_detail', `image`='$update_image' WHERE id = '$update_id'") or die('query failed');
    if ($update_query) {
...
<html lang="en">
  ...
  <body>
    <?php echo include 'admin_header.php';?> 
    <?php
if (isset($message)) {
...
if (isset($_GET['edit'])) {
    ...
    if (mysqli_num_rows($edit_query) > 0) {
        while ($fetch_edit = mysqli_fetch_assoc($edit_query)) {
            ...
            <input type="reset" name="update_id" value="cancel" class="option-btn btn" id="close-form">
            </form>
            <?php
}
    }
